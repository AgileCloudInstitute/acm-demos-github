...
# PREREQUISITE: Run configFilesGenerator.py in your devbox to create keys.yaml and config.yaml.  
#               You will be pasting the results of these instructions into that keys.yaml to replace the 
#               default dummy values for 3 fields given below. 

# Complete the following steps after completing the preresite given above.
...
# 5. Download this script into your cloudshell by typing the following into the cloudshell terminal:
...
def createSequence(userName, groupName, keyPairName):
  ...
  #4. Add "Access key – Programmatic access" for user
  # Also Retrieve the “Access key ID” and the “Secret key”
