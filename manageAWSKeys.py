...
#    python3 manageAWSKeys.py create userName=ACMUser_abc groupName=SuperUserACM_abc keyPairName=ACMKeyPair_abc
...
#    python3 manageAWSKeys.py create userName=ACMUser_xyz groupName=SuperUserACM_xyz keyPairName=ACMKeyPair_xyz
...
# python3 manageAWSKeys.py destroy userName=ACMUser_abc groupName=SuperUserACM_abc keyPairName=ACMKeyPair_abc accessKeyID=ValidAccessKeyIdThatWasCreatedByCreateCommand
# python3 manageAWSKeys.py destroy userName=ACMUser_xyz groupName=SuperUserACM_xyz keyPairName=ACMKeyPair_xyz accessKeyID=ValidAccessKeyIdThatWasCreatedByCreateCommand
...
def malformedMessage():
  ...
  print("python3 manageAWSKeys.py create userName=validUserName groupName=validGroupName keyPairName=validKeyPairname")
  print("python3 manageAWSKeys.py destroy userName=validUserName groupName=validGroupName keyPairName=validKeyPairname accessKeyID=ValidAccessKeyIdThatWasCreatedByCreateCommand")
  quit()
